...
export const metadata = {
  ...
  description:
    "Professionele website laten maken? DJ Digital Works bouwt snelle, moderne en goed vindbare websites voor ondernemers, inclusief hosting en SEO.",
...
const structuredData = {
  ...
  name: "DJ Digital",
  url: "https://djdigitalworks.nl",
  logo: "https://djdigitalworks.nl/logo.png",
  image: "https://djdigitalworks.nl/og-image-v2.png",
  description:
    "DJ Digital bouwt snelle, moderne en goed vindbare websites voor ondernemers, inclusief hosting en SEO.",
  areaServed: {
    "@type": "Country",
